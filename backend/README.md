...
| `REBUILD_CHILD_TIMEOUT_SECONDS` | `1800`                         | Per-image durable rebuild child timeout. Must be shorter than `REBUILD_LEASE_SECONDS`.                                                                                                                                                                                                                         |
| `REBUILD_LEASE_SECONDS`     | `2100`                               | Durable rebuild claim lease. Expired ownership is reclaimed and repumped from PostgreSQL.                                                                                                                                                                                                                     |

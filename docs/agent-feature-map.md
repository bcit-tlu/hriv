...
| Category versioning (OCC) | `api.ts` (`updateCategory`), `useCategoryActions.ts`, `types.ts`, `useBrowseData.ts` | `routers/categories.py`, `schemas.py`, `models.py` | `test_categories.py`, `useCategoryActions.test.ts` | — |
...
| Search modal | `components/SearchModal.tsx`, `App.tsx` | N/A (client-side over loaded browse data) | `SearchModal.test.tsx` | [`docs/ui-behaviour-spec.md`](ui-behaviour-spec.md) |
| Announcements | Announcement components | `routers/announcement.py` | `test_router_announcement.py`, `useAnnouncementModal.test.ts` | — |
| Changelog notifications | `components/NotificationMenu.tsx`, `components/ChangelogAdmin.tsx`, `components/MarkdownContent.tsx`, `App.tsx`, `api.ts` | `routers/changelog.py`, `models.py`, `schemas.py`, migration `0012_add_changelog_entries.py` | `test_router_changelog.py`, `NotificationMenu.test.tsx`, `ChangelogAdmin.test.tsx`, `api.test.ts` | [`docs/changelog-notifications.md`](changelog-notifications.md), [`README.md`](../README.md#changelog-notifications), [`docs/TESTING.md`](TESTING.md) |

...
describe("ManagePage", () => {
    ...
    it("shows the configured default visible columns", async () => {
        ...
        expect(
            screen.queryByRole("columnheader", { name: "Copyright" }),
        ).not.toBeInTheDocument();
        expect(
            screen.queryByRole("columnheader", { name: "Note" }),
        ).not.toBeInTheDocument();
    });
    ...
    it("moves focus off the Add Images trigger before opening the upload modal", async () => {
        render(
            <ManagePage
                categories={categories}
                programs={programs}
        ...
        expect(
            screen.getByRole("dialog", { name: /add images/i }),
        ).toBeInTheDocument();
    });

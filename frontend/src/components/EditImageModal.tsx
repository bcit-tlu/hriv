...
function EditImageForm({
    ...
    const isDirty =
        ...
        activeChanged ||
        measurementScale !==
            (meta?.measurement_scale != null
                ? String(meta.measurement_scale)
                : "") ||
        measurementUnit !==
    ...
    const buildFormData = (): ImageFormData | null => {
        ...
        const scaleNum = measurementScale.trim()
            ? Number(measurementScale)
            : undefined;
        ...
        const existingMeta =
            (image?.metadata_extra as Record<string, unknown>) ?? {};
        const hadMeasurement =
            existingMeta.measurement_scale != null ||
            existingMeta.measurement_unit != null;
            ...
            >
                ...
                >
                    <CloudUploadIcon
                        sx={{
                            fontSize: 36,
                            color: replaceFile ? "success.main" : "grey.500",
                            mb: 0.5,
                        }}
                    />
                    {replaceFile ? (
                        ...
                        <>
                            ...
                            >
                                ...
                                <Typography
                                    ...
                                    variant="caption"
                                    color={
                                        onReplace ? "primary" : "text.disabled"
                                    }
                                    sx={
                                        onReplace
                                            ? {
                ...
                {replaceFile && confirmReplace && (
                    <Alert severity="warning" sx={{ mt: -1 }}>
                        Replacing this image will delete the current image file,
                        all tiles, and any canvas annotations and overlays. This
                        cannot be undone. Click &quot;Replace &amp; Save&quot;
                        again to confirm.
                    </Alert>
                )}
                    ...
                    <>
                        ...
                        <Box>
                            <Button
                                color="error"
                                variant={
                                    confirmDelete ? "contained" : "outlined"
                                }
                            ...
                            {confirmDelete && (
                                ...
                                >
                                    This action cannot be undone. Click again to
                                    confirm.
                                </Typography>
                            )}
                        </Box>
            ...
            {confirmViewImage && (
                ...
                >
                    ...
                    <Box sx={{ display: "flex", gap: 1, ml: 2, flexShrink: 0 }}>
                        <Button
                            size="small"
                            onClick={() => setConfirmViewImage(false)}
                        >
                            Cancel
                        </Button>
                        <Button

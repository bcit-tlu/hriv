...
export default function UploadImageModal({
    ...
    const handleUpload = async () => {
        ...
        if (bulk) {
            ...
            const uploadFileSize = files.reduce(
        ...
        >
            ...
            >
                    ...
                    {singleFile ? (
                        ...
                        <>
                            ...
                            <Typography
                                ...
                                sx={{ mt: 1 }}
                            >
                                Supports JPEG, PNG, TIFF, GIF, WebP, SVS, and
                                ZIP files.
                            </Typography>
                        </>
                    ) : (
                ...
                <Typography
                    ...
                    sx={{ display: "block" }}
                >
                    Uploaded images are processed into zoomable views and named
                    from their filenames. ZIP uploads are automatically
                    extracted and imported, and metadata can be bulk-edited
                    later from the <strong>Images</strong> page.
                </Typography>
                {error && (
                    <Alert
                        severity="error"

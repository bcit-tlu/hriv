...
function EntryDialog({
    ...
    return (
        <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth>
            <DialogTitle>
                {initial ? "Edit Changelog Entry" : "New Changelog Entry"}
            </DialogTitle>
                ...
                <Stack spacing={2} sx={{ mt: 0.5 }}>
                    ...
                    {initial && (
                        <Typography variant="caption" color="text.secondary">
                            Saving republishes the entry and resets the unread
                            badge for all admin and instructor users.
                        </Typography>
                    )}
                </Stack>
            </DialogContent>
...
export default function ChangelogAdmin() {
    ...
    const [dialogEntry, setDialogEntry] = useState<
        ApiChangelogEntry | null | undefined
    >(undefined);
    const [deleteTarget, setDeleteTarget] = useState<ApiChangelogEntry | null>(
        null,
    );
    ...
    const load = useCallback(async () => {
        ...
        try {
            ...
            setLoadError(
                userMessage(err, "Failed to load changelog entries."),
            );
        } finally {
            setLoading(false);
        }
    ...
    return (
        <Box>
            ...
            <Alert severity="info" sx={{ mb: 2 }}>
                Changelog entries support Markdown. Creating or republishing an
                entry shows the unread badge again for admin and instructor
                users.
            </Alert>
